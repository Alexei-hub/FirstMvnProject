...
//        inputSearch.sendKeys("Mac");
        WebElement inputSearch = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@name='search']")));
        inputSearch.sendKeys("Mac");
        ...
        assertEquals(titleOfFirstItemText, productPageTitleText, "Tittle doesn't equals");

        WebElement activeLink = driver.findElement(By.xpath("//a[@class='tabs__link tabs__link--active']"));
        String colorOfActiveLink = activeLink.getCssValue("color");
        assertEquals(colorOfActiveLink, "rgba(0, 160, 70, 1)", "Color of active doesn't equals");
    }
